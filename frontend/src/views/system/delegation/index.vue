  ...
  <div class="delegation-page">
    ...
    <el-card shadow="never" style="margin-top: 12px">
      <div style="margin-bottom: 12px">
        <el-button type="primary" @click="handleAdd" v-permission="'system:delegation:edit'">新增委托</el-button>
      </div>
      ...
      <el-table :data="tableData" v-loading="loading" stripe border style="width: 100%">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="{ row }">
            <el-button v-if="row.status === 1" type="warning" link size="small" @click="handleRevoke(row)" v-permission="'system:delegation:edit'">撤销</el-button>
            <el-button type="danger" link size="small" @click="handleDelete(row)" v-permission="'system:delegation:edit'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
